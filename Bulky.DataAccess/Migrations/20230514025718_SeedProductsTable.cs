    ...
    public partial class SeedProductsTable : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Author", "Description", "ISBN", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[] { "Author 1", "A product 1", "1111", 0.0, 0.0, 0.0, 0.0, "Product 1" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Author", "Description", "ISBN", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[] { "Author 2", "A product 2", "2222", 0.0, 0.0, 0.0, 0.0, "Product 2" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Author", "Description", "ISBN", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[] { "Author 3", "A product 3", "3333", 0.0, 0.0, 0.0, 0.0, "Product 3" });
        }
    }
}
